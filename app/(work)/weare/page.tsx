...
import Preloader from '@/components/preloader/preloader_weare';
...
const Weare = () => {
  ...
  useEffect( () => {
    ...
    <div className="rounded-3xl border border-zinc-900 m-5 p-5 py-10 md:p-20 " id="home ">
        ...
        <h3 className="text-3xl md:text-5xl lg:text-7xl xl:text-8xl">WeAre</h3>
...
<Link href='https://we-are.cool/' rel="noopener noreferrer" target="_blank">
<FramerMagnetic>
