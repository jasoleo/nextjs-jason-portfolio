...
const phrases = 
[
  // "Freelancer for UI designe &Front-End Developer.",
  // "Aspiring to combine broad background with",
  // "strong technical skills to excel as a Front-End Developer.",
  // "I'm passionate about learning new skills."
  
        <span className="text-2xl indent-8 items-center justify-center font-light text-start md:text-5xl ">       
...
I'm passionate about learning new skills.</span>
